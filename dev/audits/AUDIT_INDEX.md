...
| `I18N_AUDIT_2026-09-24.md` | v3.14.419 | **LIVE** | all of §2: 6 static-shell findings, 31 rendered strings in 13 places, 1 host string. Closed by the tester build's `tb-strings` step, which also turns its scanner into a guard | no |
